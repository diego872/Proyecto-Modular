...
<body>
  ...
  <div class="container-fluid text-center presentacion">
    ...
    <div class="row justify-content-center">
      <div class="col-3">
        <a class="btn btn-lg start-btn" href="signUp.php" role="button">Comienza ahora</a>
      </div>
    </div>

    <div class="row">
      <div class="col justify-content-start">
        <img src="images/gantt-chart-1.jpeg" alt="Logo" class="img-fluid gantt-chart" />
      </div>

      <div class="col justify-content-center">
        <img src="images/gantt-chart-2.jpg" alt="Logo" class="img-fluid gantt-chart" />
      </div>
